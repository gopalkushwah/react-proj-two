...
const Videos = () => {
    ...
    return <Stack direction={['column', 'row']} h='120vh'>
        <VStack w={'full'}>
            <video
                controls
            ...
            <VStack alignItems={'flex-start'} p='8' w={'full'} overflowY='auto'>
                ...
                <Text>This is a sample video for testing and demo. This is a called description</Text>
            </VStack>
        </VStack>
        <VStack
            w={['full', 'xl']}
        ...
        >

            {
                videosArr.map((item, index) => {
                    return <Button key={index} bgColor='blackAlpha.100' variant={'ghost'} colorScheme='purple' onClick={() => setVideoSrc(item)}>Lecture {index + 1}</Button>
